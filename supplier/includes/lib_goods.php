...
/* 代码增加_虚拟团购_START  www.68ecshop.com */
         if(!$real_goods && $filter['extension_code'] == 'virtual_good'){
             $sql = "SELECT distinct(g.goods_id), goods_name,sync_erp,sync_result, goods_type, exclusive, goods_sn, shop_price, is_on_sale, is_best, is_new, is_hot, sort_order,supplier_status, goods_number, integral, " .
