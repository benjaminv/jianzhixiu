...
if (!$smarty->is_cached('mall.dwt', $cache_id))
{
    ...
    //头部图片
    if($GLOBALS['_CFG']['shop_header_text'] == "请上传logo和banner"){
        $background_text = "background:".$GLOBALS['_CFG']['shop_header_color'].";";
    }else{
        $background_text = "background:url(../".trim($GLOBALS['_CFG']['shop_header_text']).") no-repeat;background-size:100% 100%;";
    ...
    $smarty->assign('background_text',$background_text);
