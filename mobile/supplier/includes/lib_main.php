...
function create_shop_settiongs()
{
	...
	if($num>0){
		...
		$insql = "INSERT INTO ". $ecs->table('supplier_shop_config') ." (`id`, `parent_id`, `code`, `type`, `store_range`, `store_dir`, `value`, `sort_order`, `supplier_id`) VALUES
				...
				(111, 1, 'wx', 'file', '', '', '', 1, ".$_SESSION['supplier_id']."),
				(112, 1, 'skype', 'hidden', '', '', '', 1, ".$_SESSION['supplier_id']."),
				(113, 1, 'ym', 'hidden', '', '', '', 1, ".$_SESSION['supplier_id']."),
				(114, 1, 'msn', 'hidden', '', '', '', 1, ".$_SESSION['supplier_id']."),
				(115, 1, 'service_email', 'text', '', '', '', 1, ".$_SESSION['supplier_id']."),
				(116, 1, 'service_phone', 'text', '', '', '', 1, ".$_SESSION['supplier_id']."),
				(117, 1, 'shop_closed', 'select', '0,1', '', '0', 1, ".$_SESSION['supplier_id']."),
				(118, 1, 'close_comment', 'hidden', '', '', '', 1, ".$_SESSION['supplier_id']."),
				(119, 1, 'shop_logo', 'file', '', '../themes/".'{$template}'."/images/', '', 1, ".$_SESSION['supplier_id']."),
				(120, 1, 'licensed', 'hidden', '0,1', '', '1', 1, ".$_SESSION['supplier_id']."),
				(121, 1, 'user_notice', 'hidden', '', '', '用户中心公告！', 1, ".$_SESSION['supplier_id']."),
				...
				(123, 1, 'shop_reg_closed', 'hidden', '1,0', '', '0', 1, ".$_SESSION['supplier_id']."),
				...
				(126, 1, 'close_comment', 'textarea', '', '', '该店铺正在装修', 1, ".$_SESSION['supplier_id']."),
