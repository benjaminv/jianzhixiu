...
function get_template_info($template_name, $template_style='')
{
    ...
    if ($template_style == '')
    {
        foreach ($ext AS $val)
        {
            if (file_exists('../mobile/themesmobile/' . $template_name . "/images/screenshot.$val"))
            {
                $info['screenshot'] = '../mobile/themesmobile/' . $template_name . "/images/screenshot.$val";
    ...
    else
    {
        foreach ($ext AS $val)
        {
            if (file_exists('../mobile/themesmobile/' . $template_name . "/images/screenshot_$template_style.$val"))
            {
                $info['screenshot'] = '../mobile/themesmobile/' . $template_name . "/images/screenshot_$template_style.$val";
    ...
    $css_path = '../mobile/themesmobile/' . $template_name . '/style.css';
    if ($template_style != '')
    {
        $css_path = '../mobile/themesmobile/' . $template_name . "/style_$template_style.css";
    }
...
function get_template_region($tmp_name, $tmp_file, $lib=true)
{
    ...
    $file = '../mobile/themesmobile/' . $tmp_name . '/' . $tmp_file;
...
function move_plugin_library($tmp_name, &$msg)
{
    ...
    $return_value = true;
    $target_dir = ROOT_PATH . 'mobile/themesmobile/' . $tmp_name;
    $source_dir = ROOT_PATH . 'mobile/themesmobile/' . $GLOBALS['_CFG']['template'];
...
function get_editable_libs($curr_template, $curr_page_libs)
{
    ...
    $vals = array();
    $edit_libs = array();
    if ($xml_content = @file_get_contents(ROOT_PATH . 'mobile/themesmobile/dm299_com/libs.xml'))
    {
