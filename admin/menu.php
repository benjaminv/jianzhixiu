...
function get_all_menu()
{
	 ...
	 $sql = 'SELECT COUNT(*) FROM ' .$GLOBALS['ecs']->table('ecsmart_menu') ." as s ". $where ." ORDER BY sort ";
     $filter['record_count'] = $GLOBALS['db']->getOne($sql);

     $filter = page_and_size($filter);

     $arr = array();
	 $sql = "select s.* from ".$GLOBALS['ecs']->table('ecsmart_menu')." as s  $where ORDER BY sort ";
