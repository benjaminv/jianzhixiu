...
if ($_REQUEST['act'] == 'list_edit')
{
    ...
    assign_query_info();
    $smarty->display('mobile_shop_config.htm');
}
...
/*     $spt = '<script type="text/javascript" src="http://api.ecshop.com/record.php?';
    ...
    {
        $links[] = array('text' => $_LANG['back_mail_settings'], 'href' => 'mobile_shop_config.php?act=mail_settings');
        sys_msg($_LANG['mail_save_success'].$spt, 0, $links);
    }
    else
    {
        $links[] = array('text' => $_LANG['back_shop_config'], 'href' => 'mobile_shop_config.php?act=list_edit');
