...
elseif ($_REQUEST['act'] =='insert')
{
    ...
    $supplier_id = $db->GetOne("SELECT supplier_id FROM ".$ecs->table('supplier_goods_cat')." WHERE goods_id = '$_POST[goods_id]'");
    ...
    $record = array('act_name'=>$_POST['cut_name'], 'act_desc'=>$_POST['act_desc'],
                    ...
                    'product_id'=>$_POST['product_id'],'supplier_id'=>$supplier_id,
