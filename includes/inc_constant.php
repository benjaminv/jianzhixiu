...
/* 众筹活动状态*/
define('PRE_SELL_CODE',				'zhongchou'); //
define('ZC_PRE_START',             0); // 未开始
define('ZC_UNDER_WAY',             1); // 进行中
define('ZC_FINISHED',              2); // 已结束
define('ZC_SUCCEED',               3); // 众筹成功（可以发货了）
define('ZC_FAIL',                  4); // 众筹失败
