...
$_LANG['goods'] = '商品';
$_LANG['rank'] = '评价等级';
$_LANG['rank_time'] = '评价时间';
$_LANG['show_status'] = '显示状态';
...
$_LANG['lab_points_payment_amount'] = '积分购买金额'; // 积分label
...
$_LANG['notice_points_payment_amount'] = '(此处填写金额)购买该商品最多可以使用积分抵扣的金额';
