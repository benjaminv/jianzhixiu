 ...
 */
$_LANG['app_name'] = '在线商城';
$_LANG['cp_home'] = '在线商城 管理中心';
$_LANG['copyright'] = '技术支持：在线商城.';
...
$_LANG['26_pre_sell_list'] = '众筹活动';
$_LANG['26_seckill'] = '秒杀活动';
$_LANG['31_dzp'] = '大转盘抽奖活动';
...
$_LANG['03_users_virtual_list'] = '水军列表';
...
// 微信管理 微信设置
$_LANG['06_wechat_setting'] = '微信设置';
$_LANG['01_weixin_config'] = '微信设置';
$_LANG['02_weixin_oauth'] = 'OAuth设置';
$_LANG['03_weixin_menu'] = '自定义菜单';
$_LANG['04_weixin_addkey'] = '关键字回复';
$_LANG['05_weixin_keywords'] = '功能变量';
$_LANG['06_article_danpin'] = '单品推广设置';
$_LANG['07_weixin_autoreg'] = '微信注册设置';
$_LANG['08_weixin_qiandao'] = '签到设置';
$_LANG['09_weixin_egg'] = '活动管理';
$_LANG['10_weixin_log'] = '中奖管理';
$_LANG['11_weixin_qcode'] = '管理二维码';
$_LANG['12_weixin_addqcode'] = '生成二维码';
$_LANG['13_weixin_notice'] = '分享设置';
$_LANG['14_weixin_remind'] = '消息提醒设置';
$_LANG['15_weixin_news'] = '消息推送';
$_LANG['16_weixin_fans'] = '粉丝管理';
$_LANG['17_weixin_share'] = '分享记录';


// 手机模板设置
$_LANG['08_mobile_setting'] = '手机端设置';
$_LANG['01_shop_config'] = '商店设置';
$_LANG['02_menu_list'] = '自定义菜单';
$_LANG['03_ad_position'] = '广告位置';
$_LANG['04_ads_list'] = '广告列表';
$_LANG['05_template_list'] = '模板选择';
$_LANG['06_template_setup'] = '设置模板';
$_LANG['07_mobile_website'] = '手机授权登录';
$_LANG['08_mobile_captcha_manage'] = '验证码管理';


$_LANG['07_template_library'] = '库项目管理';
$_LANG['08_edit_languages'] = '语言项编辑';
$_LANG['07_article_ms'] = '互助消息列表';
$_LANG['08_articlecat_ms'] = '互助消息分类';



// 分销管理
$_LANG['07_distrib_setting']	= '分销管理';
$_LANG['01_affiliate_list']		= '分销设置';
$_LANG['02_distributor_list']	= '分销商列表';
$_LANG['03_distrib_goods_list'] = '商品设置';
$_LANG['04_affiliate_ck']		= '分成订单';
$_LANG['05_distrib_sort']		= '排行榜';
$_LANG['06_deposit_list']		= '提现申请列表';

// 二维码同步显示信息
$_LANG['22_erweima'] = '二维码同步管理';
$_LANG['er_wei_ma'] = '二维码同步信息';
$_LANG['pi_ci__number'] = '批次号管理';
$_LANG['total_code_number'] = '扫码次数';
?>