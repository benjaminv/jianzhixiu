...
//edit yhy 2019/5/14
$_LANG['send_goods_use'] = '指定使用商品';
$_LANG['goods_use'][0] = '不指定'; 
$_LANG['goods_use'][1] = '指定';

$_LANG['user_rank_switch'] = '指定会员等级';
$_LANG['user_rank_on'][0] = '不指定'; 
$_LANG['user_rank_on'][1] = '指定';
$_LANG['user_rank_list'] = '会员等级';



$_LANG['send_money_type'] = '红包金额变化';
$_LANG['money_type'][0] = '不变化,固定发放'; 
$_LANG['money_type'][1] = '按照订单金额区间';
...
$_LANG['block'] = '区间';
$_LANG['add_block'] = '新增区间';
$_LANG['remove_block'] = '移除';
$_LANG['bonus_money'] = '红包金额(-1表示和订单金额一致)';
//end yhy 2019/5/14

//edit yhy 2019/5/28
$_LANG['user_rank_distribute'] = '订单是否参与分销';
$_LANG['is_distribute'][0] = '不参与分销'; 
$_LANG['is_distribute'][1] = '参与分销';
//end yhy 2019/5/28
...
$_LANG['bonus_type4_max_notic'] = '本设置仅对(按订单金额发放)( 线下发放的红包)有效。';
//代码增加--cb--线上红包--68ecshop
