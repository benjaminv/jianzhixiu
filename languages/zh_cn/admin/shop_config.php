...
$_LANG['cfg_name']['ww'] = '百度商桥';
$_LANG['cfg_name']['wx'] = '微信二维码';
...
$_LANG['cfg_desc']['shop_url'] = '商店绑定域名，包含“http://" ';
...
$_LANG['cfg_range']['upload_size_limit']['500'] = '500KB';
...
$_LANG['upload_limit'] = '上传图片限制不能超过%s';
...
$_LANG['gzip_confirm'] = "GZip 功能需要您的服务器支持 zlib 扩展库。\\n如果您发现开启Gzip后页面出现乱码，可能是您的服务器已经开启了Gzip，您不需要在 商城 中再次开启。";
...
$_LANG['cfg_name']['shaidan_pre_num'] = '晒单前多少位可获得积分1';
...
$_LANG['cfg_name']['dayu'] = '阿里云短信设置';


$_LANG['cfg_desc']['appkey'] = '';
$_LANG['cfg_name']['dayu_shop_mobile'] = '商家的手机号码';
$_LANG['cfg_name']['appkey'] = 'Access Key ID';
$_LANG['cfg_name']['secretKey'] = 'Access Key Secret';
...
$_LANG['cfg_name']['dayu_order_placed_tpl'] = '阿里云平台申请的下订单短信模板ID';

 $_LANG['cfg_name']['dayu_zhuce'] = '注册是否发短信';
$_LANG['cfg_range']['dayu_zhuce']['1'] = '发短信';
$_LANG['cfg_range']['dayu_zhuce']['0'] = '不发短信';
$_LANG['cfg_name']['dayu_zhuce_tpl'] = '阿里云平台申请的下验证码短信模板ID';
...
$_LANG['cfg_name']['sl_status'] = '是否开启税费';
$_LANG['cfg_range']['sl_status']['0'] = '否';
$_LANG['cfg_range']['sl_status']['1'] = '是';
$_LANG['cfg_name']['sl_rate'] = '税率';
$_LANG['cfg_name']['sl_time_start'] = '分成时间';
$_LANG['cfg_name']['sl_time_end'] = '税费结束时间';
$_LANG['cfg_desc']['sl_rate'] = '税率填写小数，例如30%的税率填写0.3';
$_LANG['cfg_desc']['sl_time_start'] = '时间格式:7，表示当月7号分成';

$_LANG['cfg_name']['fc_rate'] = '提成比例';
$_LANG['cfg_desc']['fc_rate'] = '提成比例填写小数，例如30%的提成比例填写0.3';

$_LANG['cfg_name']['fx_day_num'] = '返现（确认收货后第几天）';
?>